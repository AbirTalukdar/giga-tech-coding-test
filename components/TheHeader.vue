  ...
  <nav :class="headerClassList" class="w-full z-30 top-0 mb-2">
    ...
    >
      ...
      <div class="block lg:hidden pr-4">
        ...
        ><img src="https://img.icons8.com/external-tal-revivo-regular-tal-revivo/24/000000/external-setting-toggle-switchs-for-switching-on-and-off-devices-setting-regular-tal-revivo.png"/>
        </button>
      </div>
